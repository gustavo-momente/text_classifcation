...
def main():
    ...
    FirstParser = ParserCM(r"C:\Users\Usuario\Desktop\ENSTA\M2 UPMC\Cours\FDMS\corpus.movies.learn-stem.utf8")
    cvs_log = "..\\..\\mv-svm-stemed.csv"
    stemmer = None
    text_data, Y = FirstParser.get_data()

    print "Parsing test data..."
    TestParser = ParserCMTest(r"C:\Users\Usuario\Desktop\ENSTA\M2 UPMC\Cours\FDMS\corpus.movies.test-stem.utf8")
    out_file = r"C:\Users\Usuario\Desktop\ENSTA\M2 UPMC\Cours\FDMS\101pred_movies"
    up_file = out_file
    task = "sentiment.txt"
